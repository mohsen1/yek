...
mod category_tests {
    ...
    fn test_categorize_configuration_files() {
        ...
        assert_eq!(
            categorize_file("webpack.config.js"),
            FileCategory::Configuration
        );
        assert_eq!(
            categorize_file("tsconfig.json"),
            FileCategory::Configuration
        );
        assert_eq!(categorize_file(".prettierrc"), FileCategory::Configuration);
        assert_eq!(
            categorize_file("requirements.txt"),
            FileCategory::Configuration
        );
    ...
    fn test_categorize_documentation_files() {
        ...
        assert_eq!(
            categorize_file("CONTRIBUTING.md"),
            FileCategory::Documentation
        );
        assert_eq!(categorize_file("AUTHORS"), FileCategory::Documentation);
        assert_eq!(
            categorize_file("guide/quickstart.md"),
            FileCategory::Documentation
        );
    }
    ...
    fn test_edge_case_categorization() {
        ...
        assert_eq!(
            categorize_file("rollup.config.js"),
            FileCategory::Configuration
        );
        ...
        assert_eq!(
            categorize_file("config/app.js"),
            FileCategory::Configuration
        );
        assert_eq!(
            categorize_file(".config/settings.txt"),
            FileCategory::Configuration
        );
    }
    ...
    fn test_path_normalization() {
        ...
        assert_eq!(
            categorize_file("docs\\guide\\install.md"),
            FileCategory::Documentation
        );
    }
