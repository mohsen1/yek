...
/// Tests that files are written in ascending priority order within a part.
#[test]
fn part_order_reflects_priority() {
    ...
    // Check that files appear in descending priority order
    ...
    assert!(
        ...
        "Files should be ordered by descending priority"
    );
}
