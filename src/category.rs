...
fn is_test_file(path_lower: &str, file_name: &str, extension: &Option<String>) -> bool {
    ...
    let test_directories = [
        ...
        "\\test\\", "\\tests\\", "\\__test__\\", "\\__tests__\\", "\\spec\\", "\\specs\\",
    ...
    let test_patterns = [
        "_test.", ".test.", "_spec.", ".spec.", "_e2e.", ".e2e.",
        "test_", "spec_", "e2e_",
    ];
    ...
    match extension.as_deref() {
        ...
        Some("js") | Some("ts") | Some("jsx") | Some("tsx") => {
            if file_name.ends_with(".test.js") || file_name.ends_with(".test.ts") 
                || file_name.ends_with(".spec.js") || file_name.ends_with(".spec.ts")
                || file_name.ends_with(".test.jsx") || file_name.ends_with(".test.tsx")
                || file_name.ends_with(".spec.jsx") || file_name.ends_with(".spec.tsx") {
                return true;
            }
        },
        Some("py") => {
...
fn is_configuration_file(path_lower: &str, file_name: &str, extension: &Option<String>) -> bool {
    ...
    let config_extensions = [
        ...
        "properties", "env", "rc", "lock", "sum", "mod", "makefile",
    ];
    ...
    let config_files = [
        "makefile", "dockerfile", "containerfile", "rakefile", "gemfile", "podfile",
        "vagrantfile", "brewfile", "procfile", "nixfile",
        "package.json", "composer.json", "project.json",
        "cargo.toml", "pyproject.toml", "poetry.toml", "setup.cfg", "tox.ini",
        "docker-compose.yml", "docker-compose.yaml", "docker-stack.yml", "docker-stack.yaml",
        ".gitignore", ".gitattributes", ".gitmodules",
        ".dockerignore", ".eslintrc", ".eslintrc.json", ".eslintrc.yml", ".eslintrc.yaml",
        ".prettierrc", ".babelrc", ".editorconfig",
        ".travis.yml", ".github", "appveyor.yml", "azure-pipelines.yml",
        "tsconfig.json", "jsconfig.json", "webpack.config.js", "rollup.config.js",
        "vite.config.js", "vite.config.ts", "next.config.js", "nuxt.config.js",
        "tailwind.config.js", "postcss.config.js",
        "requirements.txt", "setup.py", "setup.cfg", "manifest.in", "pipfile",
        "build.gradle", "pom.xml", "build.xml", "ivy.xml",
        "cmake", "cmakelist.txt", "meson.build",
    ];
    ...
    if file_name.starts_with('.') && !file_name.starts_with("..") {
        ...
        let non_config_dotfiles = [
            ".git", ".gitkeep", ".keep", ".empty", ".placeholder",
        ];
    ...
    let config_dirs = [
        "/config/", "/configs/", "/.config/", "/configuration/", "/settings/",
        "\\config\\", "\\configs\\", "\\.config\\", "\\configuration\\", "\\settings\\",
        // Also check for patterns that start at the beginning of the path
        "config/", "configs/", ".config/", "configuration/", "settings/",
    ];
...
fn is_documentation_file(path_lower: &str, file_name: &str, extension: &Option<String>) -> bool {
    ...
    let doc_extensions = [
        "md", "rst", "txt", "adoc", "asciidoc", "org", "wiki",
    ];
    ...
    let doc_files = [
        ...
        "notes", "notes.md", "notes.txt",
        "manual", "manual.md", "manual.txt",
        "guide", "guide.md", "guide.txt",
        "help", "help.md", "help.txt",
        "faq", "faq.md", "faq.txt",
        "install", "install.md", "install.txt",
        "usage", "usage.md", "usage.txt",
...
fn is_source_file(path_lower: &str, extension: &Option<String>) -> bool {
    ...
    let source_extensions = [
        // Popular languages
        "rs", "go", "py", "js", "ts", "jsx", "tsx", "java", "kt", "scala",
        "c", "cpp", "cc", "cxx", "c++", "h", "hpp", "hxx", "h++",
        "cs", "vb", "fs", "fsx", "fsi",
        "php", "rb", "pl", "pm", "r", "m", "mm", "swift",
        "dart", "lua", "sh", "bash", "zsh", "fish", "ps1", "bat", "cmd",
        "clj", "cljs", "cljc", "ex", "exs", "erl", "hrl",
        "hs", "lhs", "elm", "ml", "mli", "ocaml",
        // Web technologies
        "html", "htm", "css", "scss", "sass", "less", "vue", "svelte",
        // Mobile
        "m", "mm", "swift", "kt", "java", "dart",
        // System/Low-level
        "asm", "s", "nasm", "v", "vhd", "vhdl",
        // Functional
        "clj", "cljs", "hs", "elm", "ml", "fs",
        // Other
    ...
    let source_dirs = [
        "/src/", "/source/", "/lib/", "/libs/", "/app/", "/application/",
        "\\src\\", "\\source\\", "\\lib\\", "\\libs\\", "\\app\\", "\\application\\",
        // Also check for patterns that start at the beginning of the path
        "src/", "source/", "lib/", "libs/", "app/", "application/",
    ];
